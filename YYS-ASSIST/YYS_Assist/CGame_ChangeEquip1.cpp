...
IMPLEMENT_DYNAMIC(CGame_ChangeEquip1, CDialog)
CGame_ChangeEquip1::CGame_ChangeEquip1(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_CHANGEEQUIP, pParent)
{
}
CGame_ChangeEquip1::~CGame_ChangeEquip1()
{
}
void CGame_ChangeEquip1::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CGame_ChangeEquip1, CDialog)
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
// CGame_ChangeEquip1 消息处理程序
BOOL CGame_ChangeEquip1::OnInitDialog()
{
	...
	int preset1 = sPreset->ReadLine(lineg, 10, fname1);
	int preset2 = sPreset->ReadLine(linet, 11, fname1);
...
HBRUSH CGame_ChangeEquip1::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
