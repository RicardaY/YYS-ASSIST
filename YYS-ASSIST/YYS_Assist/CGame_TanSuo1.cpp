...
#include<any>
// CGame_TanSuo1 对话框
IMPLEMENT_DYNAMIC(CGame_TanSuo1, CDialog)
CGame_TanSuo1::CGame_TanSuo1(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_TanSuo_DLG, pParent)
{
}
CGame_TanSuo1::~CGame_TanSuo1()
{
}
void CGame_TanSuo1::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CGame_TanSuo1, CDialog)
	ON_BN_CLICKED(IDC_BTN_Tansuo_ADDTOLIST, &CGame_TanSuo1::OnBnClickedBtnTansuo1Addtolist)
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
// CGame_TanSuo1 消息处理程序
BOOL CGame_TanSuo1::OnInitDialog()
{
	CDialog::OnInitDialog();
	// TODO:  在此添加额外的初始化
	std::vector<std::any> line;
	int preset = sPreset->ReadLine(line, 4, fname1);
...
extern CGame1 *p;
void CGame_TanSuo1::OnBnClickedBtnTansuo1Addtolist()
{
	//获取参数
	UpdateData(true);
	//次数
...
HBRUSH CGame_TanSuo1::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
