...
IMPLEMENT_DYNAMIC(SuperKing2, CDialog)

SuperKing2::SuperKing2(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_SUPERKING, pParent)
{

}

SuperKing2::~SuperKing2()
{
}

void SuperKing2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(SuperKing2, CDialog)
	ON_BN_CLICKED(IDC_BTN_ADDTOLIST, &SuperKing2::OnBnClickedBtnAddtolist)
END_MESSAGE_MAP()


// SuperKing2 消息处理程序
BOOL SuperKing2::OnInitDialog()
{
...
extern CGame2 *p;
void SuperKing2::OnBnClickedBtnAddtolist()
{
	//获取参数
	UpdateData(true);
	//打几只
...
HBRUSH SuperKing2::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
