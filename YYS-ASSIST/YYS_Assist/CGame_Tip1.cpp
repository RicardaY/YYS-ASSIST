...
IMPLEMENT_DYNAMIC(CGame_Tip1, CDialog)

CGame_Tip1::CGame_Tip1(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_TIPS, pParent)
{

}

CGame_Tip1::~CGame_Tip1()
{
}

void CGame_Tip1::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CGame_Tip1, CDialog)
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
...
HBRUSH CGame_Tip1::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
